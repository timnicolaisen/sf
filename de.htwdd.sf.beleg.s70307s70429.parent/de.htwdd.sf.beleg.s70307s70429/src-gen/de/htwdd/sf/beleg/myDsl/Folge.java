 ...
 * </p>
 * <ul>
 *   <li>{@link de.htwdd.sf.beleg.myDsl.Folge#getAtom <em>Atom</em>}</li>
 *   <li>{@link de.htwdd.sf.beleg.myDsl.Folge#getAtoms <em>Atoms</em>}</li>
 * </ul>
 *
 * @see de.htwdd.sf.beleg.myDsl.MyDslPackage#getFolge()
 * @model
 * @generated
 */
public interface Folge extends EObject
{
   ...
   * @see #setAtom(Atom)
   * @see de.htwdd.sf.beleg.myDsl.MyDslPackage#getFolge_Atom()
  ...
  /**
   * Sets the value of the '{@link de.htwdd.sf.beleg.myDsl.Folge#getAtom <em>Atom</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link de.htwdd.sf.beleg.myDsl.Atom}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.htwdd.sf.beleg.myDsl.MyDslPackage#getFolge_Atoms()
   * @model containment="true"
   * @generated
   */
  EList<Atom> getAtoms();
